...
SWIFT_CLASS("_TtC18StarscreamSocketIO7SSLCert")
...
SWIFT_CLASS("_TtC18StarscreamSocketIO11SSLSecurity")
...
/// Designated init
/// \param certs is the certificates or public keys to use
///
/// \param usePublicKeys is to specific if the publicKeys or certificates should be used for SSL pinning validation
///
///
...
- (BOOL)isValid:(SecTrustRef _Nonnull)trust domain:(NSString * _Nullable)domain SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
@end
...
SWIFT_CLASS("_TtC18StarscreamSocketIO9WebSocket")
